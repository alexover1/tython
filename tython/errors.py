...
class IllegalCharError(Error):
    def __init__(self, pos_start, pos_end, details: str):
        super().__init__(pos_start, pos_end, Errors.IllegalCharError.name, details)


class ExpectedCharError(Error):
    def __init__(self, pos_start, pos_end, details: str):
        super().__init__(pos_start, pos_end, Errors.ExpectedCharError.name, details)


class SyntaxError(Error):
    def __init__(self, pos_start, pos_end, details: str):
        super().__init__(pos_start, pos_end, Errors.SyntaxError.name, details)


class RuntimeError(Error):
    def __init__(self, pos_start, pos_end, details: str, context):
        super().__init__(pos_start, pos_end, Errors.RuntimeError.name, details)
