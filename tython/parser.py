...
from .node import NumberNode, VarAccessNode, VarAssignNode, BinOpNode, UnaryOpNode
...
class Parser:
    ...
    def expr(self):
        ...
        if self.current_tok.matches(TokenType.KEYWORD, "int"):
            res.register_advancement()
            self.advance()
            ...
            if res.error:
                return res
            return res.success(VarAssignNode(var_name, expr, "int"))
